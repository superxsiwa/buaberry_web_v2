...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(loginControllerProvider, (AuthUiModel? previous, AuthUiModel next) {
      if (next.user != null) {
                  ...
                  children: <Widget>[
                    ...
                    Center(
                      child: Text('Welcome to the app',
                          style: TextStyle(fontSize: 26, fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.primary)),
                    ),
                    const Gap(10),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            icon: Icon(
                              authUiModel.showPassword ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                            ),
                            onPressed: () => ref.read(loginControllerProvider.notifier).updateShowPassword(!authUiModel.showPassword),
                          )),
                    ),
                    const Gap(10),
                    Row(
                        ...
                        SizedBox(
                            ...
                            child: Checkbox(
                              ...
                              onChanged: (bool? value) {
                                ref.read(loginControllerProvider.notifier).updateRememberMe(value ?? false);
                              },
                        ...
                        ref
                          ...
                          (LoginResponse loginResponse) {
                            ...
                            if (loginResponse.token.isNotEmpty && context.mounted) {
                              ...
                              context.push(BRRoute.menu.route);
                            }
                          },
                        );
                      },
